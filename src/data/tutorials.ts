...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	tectonique: [
		...
		{ emoji: '🪨', title: 'Les rochers', body: 'Un rocher est planté dans le sol : la flèche dessus dit le seul axe où il peut encore bouger. Un rocher ↕ ne bronche pas quand tu pousses sa ligne — les caisses viennent se tasser contre lui — mais il se déplace si tu pousses sa colonne. Un rocher ↔ fait l\'inverse.' },
