...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	luge: [
		...
		{ emoji: '❄️', title: 'Sections spéciales', body: 'Aux bifurcations, choisis ton côté (foncer dans le séparateur = crash !) : le couloir de glace à bosses secoue et freine, mais rapporte +50 points et un boost. Sur la glace (grottes, couloirs), le sol glisse et des stalagmites barrent le passage — grimpe sur les parois pour les éviter ; te coincer ne coûte pas de vie mais écrase ta vitesse. Et dans les pistes de bobsleigh gelées, plus tu carves haut dans les virages, plus tu vas vite.' },
