...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	'tempo': [
		...
		{ emoji: '♾️', title: 'Mode Infini', body: 'Choisis « Infini » pour une mélodie générée sans fin qui ACCÉLÈRE peu à peu : les tuiles se resserrent et ça va de plus en plus vite. Le score grimpe tant que tu enchaînes ; la partie s\'arrête à la première tuile ratée. Bats ton record !' },
