...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	'cocotte-mineuse': [
		...
		{ emoji: '🛠️', title: 'L\'atelier', body: 'Le bouton Atelier met en pause (la lampe brûle au ralenti). Combine 2 ressources : torche (charbon+silex, recharge la lampe), bombe (charbon+fer, se pose à tes pieds et explose après 3 s — éloigne-toi ou elle t\'emporte, pratique pour percer un mur de pierres), étai (fer+cuivre, cale une pierre), détecteur (cuivre+cristal). Les bijoux (bague, collier) donnent un bonus de score ; la couronne (bague+diamant) est la victoire.' },
