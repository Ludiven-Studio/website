...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	circuit: [
		{ emoji: '⚡', title: 'Le but', body: 'Toutes les tuiles doivent être alimentées par le générateur ⚡, et aucun tuyau ne doit rester dans le vide. Les ampoules raccordées s\'allument : c\'est ta boussole.' },
	...
	lumen: [
		...
		{ emoji: '🌈', title: 'Les couleurs', body: 'Le prisme sépare la lumière par n\'importe quelle face : une couleur continue tout droit, une part à gauche, une à droite — le faire pivoter échange les rôles. Le mélangeur fait l\'inverse : tous les rayons qui le touchent ressortent fusionnés en un seul faisceau, vers sa flèche. Deux couleurs ensemble se mélangent : rouge + vert = jaune, rouge + bleu = magenta, vert + bleu = cyan, les trois = blanc.' },
	...
	tectonique: [
		{ emoji: '💎', title: 'Le but', body: 'Les cristaux flottent au-dessus des tapis roulants de l\'usine et ne bougent jamais. La cocotte, elle, est posée sur le tapis, au milieu des bacs en plastique : fais-la passer sur chaque cristal pour tous les avaler, en le moins de coups possible.' },
		{ emoji: '🕹️', title: 'Lancer le tapis', body: 'Seules la ligne et la colonne où se trouve la cocotte peuvent bouger. Pose le doigt sur la grille et tire : le tapis suit ta main case par case. Quand tu lâches, il garde ta vitesse et continue tout seul — ces tapis sont lourds, il faut plusieurs secondes au frottement pour les arrêter. Pour le couper avant, retouche la grille (ou appuie sur une flèche) : c\'est le frein. Les flèches du clavier (ou ZQSD) et le pavé ◀▲▼▶ donnent une impulsion toute faite. Le sol est un quadrillage de tapis roulants qui se croisent. Sous la cocotte, le croisement est un plateau tournant : les deux tapis le desservent, donc les quatre directions sont ouvertes — les chevrons autour d\'elle montrent celles qui restent possibles. La cocotte et les bacs glissent dessus : quand l\'un bute contre le mur ou contre un autre, il reste en arrière pendant que le tapis continue de tourner — c\'est comme ça que tout se tasse et que les trous se referment. Même coincée, la cocotte n\'arrête pas le tapis : il défile sous ses pattes.' },
		{ emoji: '⚙️', title: 'Caisses en fer et plots', body: 'Une caisse en fer, pleine de pièces trop lourdes, est boulonnée à son tapis : elle ne glisse pas dessus, elle voyage exactement avec lui. Du coup, dès qu\'elle bute contre quelque chose, c\'est toute la ligne qui s\'arrête là — les bacs derrière viennent se tasser contre elle. Un plot, lui, est vissé à travers le tapis jusqu\'au bâti en dessous : la ligne qu\'il tient ne bouge plus du tout. Sa rainure indique le seul sens où le tapis peut encore l\'emmener ; le plot boulonné, sans rainure, bloque sa ligne et sa colonne.' },
		{ emoji: '🚧', title: 'Les piliers', body: 'Un pilier rayé jaune et noir est scellé au bâti de l\'usine, en plein milieu du plateau. Il ne voyage jamais et le tapis continue de tourner autour, mais rien ne le traverse : il coupe sa ligne et sa colonne en deux, et chaque moitié se tasse de son côté. C\'est ce qui permet enfin de s\'arrêter ailleurs qu\'au bord — et si une caisse en fer vient buter contre un pilier, elle fige toute la ligne pour de bon.' },
		{ emoji: '🧩', title: 'Se coincer', body: 'Les trous se referment pour de bon : relancer le tapis dans l\'autre sens ne remet pas la ligne comme elle était, alors réfléchis avant de pousser. Si plus rien ne bouge autour de la cocotte, la partie s\'arrête net ; et si tu perds simplement le fil, le jeu te propose de recommencer au bout d\'un moment sans cristal. La grille est toujours résoluble depuis le départ — c\'est le chemin qu\'il faut trouver.' },
		{ emoji: '🏆', title: 'Niveaux & défi', body: '100 niveaux, de 6×6 à 8×8 : les étoiles se gagnent au nombre de coups, et un coup c\'est un tapis, pas une case. Tant que tu relances le même tapis — aussi loin que tu veux, dans un sens comme dans l\'autre — ça reste le même coup ; tu ne paies qu\'en changeant de tapis. Vise donc le par en tirant tout ce qu\'il y a à tirer d\'une ligne avant de passer à l\'autre. Au défi du jour, même grille pour tout le monde — c\'est le nombre de cristaux ramassés qui compte, et le temps ne sert qu\'à départager. Tu peux arrêter ton essai quand tu veux : ce qui est déjà avalé reste au classement.' },
	],
	codecolor: [
	...
	'casse-briques': [
		...
		{ emoji: '🎮', title: 'Contrôles', body: 'Glisse le doigt (ou la souris) pour déplacer la raquette — la cocotte rebondit selon l\'endroit qu\'elle touche : vers le bord pour l\'envoyer sur le côté. Au clavier : flèches gauche/droite, Espace pour lancer. La raquette est bombée : le rebond dépend vraiment de l\'angle d\'arrivée et de l\'endroit touché.' },
		{ emoji: '🧱', title: 'Les briques', body: 'Trois duretés : les claires cassent d\'un coup, les plus foncées demandent deux coups, les plus sombres trois — et elles rapportent d\'autant plus. Chaque impact éclaircit la brique : tu vois toujours combien de coups il reste. Et plus le mur se vide, plus la cocotte accélère.' },
		{ emoji: '🎁', title: 'Les bonus', body: 'Certaines briques lâchent un bonus qui tombe — attrape-le avec la raquette : 📏 raquette large, ⚡ multi-cocottes (×3), 💥 cocotte puissante (casse d\'un coup), 🔥 cocotte de feu (traverse les briques qu\'elle casse, mais rebondit sur les plus dures), 🥚 cocotte qui se dédouble à chaque rebond jusqu\'à 16, ❤️ vie en plus, 🐢 ralenti. Chaque brique piégée porte son bonus écrit dessus : vise celui que tu veux ! Et tous les 200 points, un bonus tombe tout seul du mur. Le plumage de la cocotte change selon son pouvoir.' },
	...
	'cocotte-mineuse': [
		{ emoji: '⛏️', title: 'Le but', body: 'Creuse toujours plus bas et ramasse les minerais : plus c\'est profond, plus c\'est précieux. Ton score = profondeur + minerais + bonus des bijoux. Une averse 🌧 descend sans cesse du ciel, dissout le sable et fait tomber les pierres : reste devant elle, sinon tu es noyée ! Forge la COURONNE à l\'atelier pour un énorme bonus de score.' },
		{ emoji: '🪨', title: 'Gare aux pierres', body: 'Déplace la cocotte case par case (flèches/ZQSD, glisse-doigt ou pavé tactile) ; maintiens pour avancer. Rien ne tient en l\'air : creuse sous une pierre ou une gemme et, dès que tu quittes la case, elle TREMBLE puis tombe. Seules les PIERRES t\'écrasent en tombant — file sur le côté pour esquiver. Une gemme, elle, tu la ramasses au passage : creuser sous une poche de diamants, c\'est une pluie de gemmes à récupérer !' },
		{ emoji: '💎', title: 'Pierres & pyramides', body: 'Pierres et gemmes sont un peu arrondies (façon Boulder Dash) : posée sur un autre bloc dur, une pierre ou une gemme roule vers un côté libre et forme des pyramides — elle ne tient que si les deux côtés sont bloqués. Elles reposent à plat sur le sable. Creuse dans une poche de diamants et ça déferle !' },
		{ emoji: '🛠️', title: 'L\'atelier', body: 'Le bouton Atelier met en pause (l\'averse ralentit mais continue). Combine 2 ressources : torche (charbon+silex, éclaire mieux), bombe (charbon+fer, explose après 3 s — éloigne-toi ou elle t\'emporte, pratique pour percer un mur de pierres), pioche (cuivre+silex, casse la pierre juste devant toi — la sortie quand tu es coincée), étai (fer+cuivre, cale une pierre), détecteur (cuivre+cristal, révèle les gemmes). Les bijoux (bague, collier) donnent un bonus de score ; la couronne (bague+diamant) en donne un énorme.' },
