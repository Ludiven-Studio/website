...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	tectonique: [
		...
		{ emoji: '🧩', title: 'Se coincer', body: 'Les trous se referment pour de bon : un coup ne se rejoue pas à l\'envers, alors réfléchis avant de pousser. Si plus rien ne bouge autour de la cocotte, la partie s\'arrête net ; et si tu perds simplement le fil, le jeu te propose de recommencer au bout d\'un moment sans cristal. La grille est toujours résoluble depuis le départ — c\'est le chemin qu\'il faut trouver.' },
		{ emoji: '🏆', title: 'Niveaux & défi', body: '100 niveaux, de 6×6 à 8×8 : les étoiles se gagnent au nombre de coups, et chaque case parcourue compte pour un coup — laisser filer un tapis coûte cher, c\'est en freinant au bon moment qu\'on vise le par. Au défi du jour, même grille pour tout le monde — c\'est le nombre de cristaux ramassés qui compte, et le temps ne sert qu\'à départager. Tu peux arrêter ton essai quand tu veux : ce qui est déjà avalé reste au classement.' },
	],
	codecolor: [
