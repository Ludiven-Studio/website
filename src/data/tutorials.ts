...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	tectonique: [
		...
		{ emoji: '🕹️', title: 'Pousser le tapis', body: 'Seules la ligne et la colonne où se trouve la cocotte peuvent bouger, et d\'une case à la fois. Quatre coups possibles, pas un de plus : flèches du clavier (ou ZQSD), pavé ◀▲▼▶ sous la grille, ou un petit glissé sur la grille. Le sol est un quadrillage de tapis roulants qui se croisent. La cocotte et les bacs glissent dessus : quand l\'un bute contre le mur ou contre un autre, il reste en arrière pendant que le tapis continue de tourner — c\'est comme ça que tout se tasse et que les trous se referment. Même coincée, la cocotte n\'arrête pas le tapis : il défile sous ses pattes.' },
		...
		{ emoji: '🏆', title: 'Niveaux & défi', body: '100 niveaux, de 6×6 à 8×8 : les étoiles se gagnent au nombre de coups — moins tu pousses les tapis, plus tu brilles. Au défi du jour, même grille pour tout le monde — c\'est le nombre de cristaux ramassés qui compte, et le temps ne sert qu\'à départager. Tu peux arrêter ton essai quand tu veux : ce qui est déjà avalé reste au classement.' },
	],
	codecolor: [
