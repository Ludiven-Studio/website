...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	tectonique: [
		...
		{ emoji: '🕹️', title: 'Pousser le sol', body: 'Attrape une ligne ou une colonne et fais-la glisser : le sol défile et emmène tout ce qui est posé dessus. Seules les caisses glissent sur le sol : quand l\'une bute contre le mur ou contre une autre, elle reste en arrière — c\'est comme ça qu\'elles se tassent et que les trous se referment. Au relâchement ça continue sur sa lancée. À plusieurs doigts, tu peux pousser plusieurs lignes (ou plusieurs colonnes) d\'un coup. Au clavier, les flèches poussent la ligne du nid.' },
		...
		{ emoji: '🏆', title: 'Niveaux & défi', body: '100 niveaux, de 6×6 à 10×10 : les étoiles se gagnent au chrono. Au défi du jour, même grille pour tout le monde, classement au temps. Comme les trous se referment, un coup ne se rejoue pas à l\'envers : si tu te coinces, ↻ remet la grange à zéro (la grille est toujours résoluble depuis le départ).' },
	],
	codecolor: [
