...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	tectonique: [
		...
		{ emoji: '🏆', title: 'Niveaux & défi', body: '100 niveaux, de 6×6 à 10×10 : les étoiles se gagnent au chrono. Au défi du jour, même grille pour tout le monde — c\'est le nombre de cristaux ramassés qui compte, et le temps ne sert qu\'à départager. Tu peux arrêter ton essai quand tu veux : ce qui est déjà avalé reste au classement.' },
	],
	codecolor: [
