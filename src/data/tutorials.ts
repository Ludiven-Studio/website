...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	luge: [
		{ emoji: '🛷', title: 'Le but', body: 'Dévale une montagne enneigée en luge. Chaque mètre rapporte des points multipliés par ta vitesse (le ×N affiché suit ton compteur, jusqu\'à ×2,5) : rester lancé paie, se traîner après un crash ne rapporte presque rien.' },
