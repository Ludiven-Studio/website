...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	tectonique: [
		...
		{ emoji: '🕹️', title: 'Pousser le sol', body: 'Attrape une ligne ou une colonne et fais-la glisser : le sol défile et pousse tout ce qui est posé dessus. Les caisses et le nid courent dans ce sens et s\'empilent contre le mur, contre un rocher, ou les unes contre les autres — les trous se referment derrière. Au relâchement ça continue sur sa lancée. À plusieurs doigts, tu peux pousser plusieurs lignes (ou plusieurs colonnes) d\'un coup. Au clavier, les flèches poussent la ligne du nid.' },
		{ emoji: '🪨', title: 'Les rochers', body: 'Un rocher est planté dans le sol : la flèche dessus dit le seul axe où il peut encore bouger. Un rocher ↕ ne bronche pas quand tu pousses sa ligne — les caisses viennent se tasser contre lui — mais il se déplace si tu pousses sa colonne. Un rocher ↔ fait l\'inverse. Le bloc ✖, lui, est planté des deux côtés : il ne bouge jamais, quoi que tu pousses.' },
