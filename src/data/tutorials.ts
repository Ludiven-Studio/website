...
export const TUTORIALS: Record<string, TutorialStep[]> = {
	...
	tectonique: [
		{ emoji: '💎', title: 'Le but', body: 'Les cristaux flottent au-dessus du sol de la grange et ne bougent jamais. La cocotte, elle, est posée sur son nid, au milieu des caisses : fais passer le nid sur chaque cristal pour tous les avaler, en le moins de coups possible.' },
		{ emoji: '🕹️', title: 'Pousser le sol', body: 'Seules la ligne et la colonne où se trouve la cocotte peuvent bouger, et d\'une case à la fois. Quatre coups possibles, pas un de plus : flèches du clavier (ou ZQSD), pavé ◀▲▼▶ sous la grille, ou un petit glissé sur la grille. Le sol défile et emmène tout ce qui est posé dessus. Seules les caisses glissent sur le sol : quand l\'une bute contre le mur ou contre une autre, elle reste en arrière — c\'est comme ça qu\'elles se tassent et que les trous se referment.' },
		{ emoji: '🪨', title: 'Rochers et pieux', body: 'Un rocher est simplement posé sur le sol : il ne glisse pas dessus, il voyage exactement avec lui. Du coup, dès qu\'il bute contre quelque chose, c\'est toute la ligne qui s\'arrête là — les caisses derrière viennent se tasser contre lui. Le nid de la cocotte se comporte pareil. Un pieu, lui, est planté à travers le sol jusqu\'à la terre en dessous : la ligne qu\'il tient ne bouge plus du tout. Sa rainure indique le seul sens où le sol peut encore l\'emmener ; le pieu boulonné, sans rainure, bloque sa ligne et sa colonne.' },
		...
		{ emoji: '🏆', title: 'Niveaux & défi', body: '100 niveaux, de 6×6 à 8×8 : les étoiles se gagnent au nombre de coups — moins tu pousses le sol, plus tu brilles. Au défi du jour, même grille pour tout le monde — c\'est le nombre de cristaux ramassés qui compte, et le temps ne sert qu\'à départager. Tu peux arrêter ton essai quand tu veux : ce qui est déjà avalé reste au classement.' },
	],
	codecolor: [
